package org.apache.jsp.english.search;
...
List list = (List)pageUtil.getList();
      ...
      out.write("\t\turl = \"/english/searchNewsEn.do?pageNumber=\"+pno+\"&name=\"+");
...
if(imageMap.get("link")!=null&&((String)imageMap.get("link")).length()>0){
      ...
      if (_jspx_meth_ww_005fproperty_005f1(_jspx_page_context))
        return;
      out.write("</label>”：共");
      out.print(pageUtil.getRowCount() );
      out.write("条</span>\r\n");
      out.write("                    \t<form id=\"form1\" name=\"form1\" action=\"\">\r\n");
      out.write("                    \t\t<input name=\"name\" id=\"names\" type=\"text\" class=\"txt_search3\" /><span>按分类:</span>\r\n");
      out.write("                    \t\t<select id=\"types\"  class=\"slt_tyle\">\t\r\n");
      out.write("\t\t\t\t              <option value=\"0\">news</option>\r\n");
      out.write("\t\t\t\t  \t  \t\t<option value=\"1\">products</option>\r\n");
      out.write("\t\t\t\t  \t  \t\t</select>\r\n");
...
if(map.get("center_id").equals(1)) {
      out.write(" href=\"queryQiyeNewsDetailEn.do?newsId=");
      out.print(map.get("id"));
      out.write("#mright\"");
} else{
      out.write(" href=\"queryHyeNewsDetailEn.do?newsId=");
      out.print(map.get("id"));
      out.write("#mright\"");
} 
      out.write('>');
...
if(pageUtil.getPageCount()<pageUtil.getPageNumber()+1){
      ...
      out.write("\t\tvar type = document.getElementById(\"types\").value;\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(type==0)\r\n");
      out.write("\t\t\t\t\tform1.action=\"/chinese/searchNewsEn.do\";\r\n");
      out.write("\t\t\t\tif(type==1)\r\n");
      out.write("\t\t\t\t\tform1.action=\"/chinese/searchProductEn.do\";\r\n");
      out.write(" \r\n");
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /english/search/news.jsp(27,60) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /english/search/news.jsp(79,39) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
