...
public final class adminUserPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	List statusList = (List)request.getAttribute("statusList");
      ...
      out.write("\t\tform.action = \"adminUserPage.do\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareAddAdminUser(){\r\n");
      out.write("\t\t");
      if (_jspx_meth_auth_005fif_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareAddAdminUser.do\",\"新增用户\",450,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareUpdateAdminUserStatus(id){\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateAdminUserStatus.do?id=\"+id,\"修改用户状态\",350,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareUpdateAdminUser(id){\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateAdminUser.do?id=\"+id,\"修改用户信息\",450,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareUpdateAdminUserPassword(id){\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateAdminUserPassword.do?id=\"+id,\"修改用户密码\",450,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction adminGroupList(userId){\r\n");
      out.write("\t\tif(openDialog(\"adminGroupList.do?uId=\"+userId,\"角色分配\",650,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction adminUserMenuList(userId){\r\n");
      out.write("\t\tif(openDialog(\"adminUserMenuList.do?userId=\"+userId,\"分配菜单\",650,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleteAdminUser(id,userName){\r\n");
      out.write("\t\tif(confirm('是否删除此用户[用户:'+userName+']?')==false){\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar params = '';\r\n");
      out.write("\t\tvar url =\"deleteAdminUser.do?id=\"+id;\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction refresh(){\r\n");
      out.write("\t\tvar form = findById(\"form\");\r\n");
      out.write("\t\tform.action = \"adminUserPage.do?pageNumber=");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<table width=\"96%\" align=\"center\" border=\"0\"><tr><td><div class=\"title\">用户管理</div></td></tr></table>\r\n");
      out.write("<table width=\"96%\" cellspacing=\"1\" cellpadding=\"1\" align=\"center\">\r\n");
      out.write("\t<form id='form' action=\"adminUserPage.do\" method=\"POST\">\r\n");
      out.write("\t  ");
      ...
      out.write("\t\t\t&nbsp;姓名：<input id=\"name\" name=\"name\" size=\"11\" value=\"");
...
for(Iterator it = statusList.iterator();it.hasNext();){
      ...
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" id=\"add\" name=\"add\" value=\"新增用户...\" class=\"mainoption\" onClick=\"prepareAddAdminUser();\">\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t  </tr>\r\n");
      out.write("\t</form>\r\n");
      out.write("</table>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(auv.getUserName())?"---":auv.getUserName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(auv.getName())?"---":auv.getName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(DictionaryCache.getValueByCode(Dictionary.ADMIN_USER_TYPE,auv.getType()+""));
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
if(auv.getStatus().intValue()==0){
      out.print(DictionaryCache.getValueByCode(Dictionary.ADMIN_USER_STATUS,auv.getStatus()+""));
}else{
      out.write("<font color=\"#FF0000\">");
      out.print(DictionaryCache.getValueByCode(Dictionary.ADMIN_USER_STATUS,auv.getStatus()+""));
      out.write("</font>");
}
      out.write("&nbsp;<input type=\"button\" id=\"update\" name=\"update\" value=\"修改...\" class=\"mainoption\" onClick=\"javascript:prepareUpdateAdminUserStatus(");
      out.print(auv.getId());
      out.write(");\"></td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(auv.getCreateTime());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(auv.getCreator());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td align=\"left\">");
if(auv.getType().intValue()==0){
      out.write("<input type=\"button\" value=\"角色分配...\" onClick=\"javascript:adminGroupList(");
      out.print(auv.getId());
      out.write(");\">");
}
      out.write("\r\n");
      out.write("\t\t\t\t");
if(auv.getType().intValue()==0){
      out.write("<input type=\"button\" value=\"菜单分配...\" onClick=\"javascript:adminUserMenuList(");
      out.print(auv.getId());
      out.write(");\">");
}
      out.write("\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"修改信息...\" onClick=\"javascript:prepareUpdateAdminUser(");
      out.print(auv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"修改密码...\" onClick=\"javascript:prepareUpdateAdminUserPassword(");
      out.print(auv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"删除...\" onClick=\"javascript:deleteAdminUser(");
      out.print(auv.getId());
      out.write(',');
      out.write('\'');
      out.print(auv.getUserName());
      out.write("');\"></td>\r\n");
      out.write("\t\t\t  </tr>\r\n");
      out.write("\t");
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_auth_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /admin/adminUserPage.jsp(27,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f0.setTest("prepareAddAdminUser.do");
    // /admin/adminUserPage.jsp(27,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_auth_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("alert('对不起，您没有此权限!');return;");
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/adminUserPage.jsp(63,45) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /admin/adminUserPage.jsp(68,19) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f2(PageContext _jspx_page_context)
    ...
    // /admin/adminUserPage.jsp(69,21) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/adminUserPage.jsp(78,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f3(PageContext _jspx_page_context)
    ...
    // /admin/adminUserPage.jsp(81,58) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
