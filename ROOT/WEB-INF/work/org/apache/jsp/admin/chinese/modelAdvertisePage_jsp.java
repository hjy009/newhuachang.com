...
public final class modelAdvertisePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	List statusList = (List)request.getAttribute("statusList");
      ...
      out.write("\t\tform.action = \"modelAdvertisePage.do\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction queryModelAdvertise(id){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"queryModelAdvertise.do?id=\"+id,\"查看招聘信息\",550,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction prepareAddModelAdvertise(){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f1(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareAddModelAdvertise.do\",\"新增招聘信息\",850,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction prepareUpdateModelAdvertise(id){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f2(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateModelAdvertise.do?id=\"+id,\"修改招聘信息\",850,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction auditModelAdvertise(id,pageId){\r\n");
      out.write("\t");
      ...
      out.write("\t\tvar url = 'auditModelAdvertise.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction reAuditModelAdvertise(id,pageId){\r\n");
      out.write("\t");
      ...
      out.write("\t\tvar params = 'id='+id;\r\n");
      out.write("\t\tvar url = 'reAuditModelAdvertise.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction deleteModelAdvertise(id,pageId){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f5(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(confirm(\"是否删除此动态id：[\"+pageId+\"] ？\") == false) return ;\r\n");
      out.write("\t\tvar params = 'id='+id;\r\n");
      out.write("\t\tvar url = 'deleteModelAdvertise.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t    }\r\n");
      out.write("\t\t    if(ary.length<1) {\r\n");
      out.write("\t\t\t\talert(\"至少选择一个招聘信息进行重审核\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(confirm(\"是否批量重审核您所选的选项 ？\") == false) return ;\r\n");
      out.write("\t\t\tvar params = 'ShenHeId='+ary;\r\n");
      out.write("\t\t\tvar url = 'reUpdateAllModelAdvertise.do';\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      ...
      out.write("\t\t    }\r\n");
      out.write("\t\t    if(ary.length<1) {\r\n");
      out.write("\t\t\t\talert(\"至少选择一个招聘信息进行删除\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(confirm(\"是否批量删除您所选的选项 ？\") == false) return ;\r\n");
      out.write("\t\t\tvar params = 'ShenHeId='+ary;\r\n");
      out.write("\t\t\tvar url = 'deleteAllModelAdvertise.do';\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<table width=\"96%\" align=\"center\" border=\"0\"><tr><td><div class=\"title\">招聘信息管理</div></td></tr></table>\r\n");
      ...
      out.write("\t\t\t职位：<input id=\"name\" name=\"name\" size=\"11\" value=\"");
...
for(Iterator it = statusList.iterator();it.hasNext();){
      ...
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" name=\"add\" value=\"新增招聘信息...\" class=\"mainoption\" onClick=\"javascript:prepareAddModelAdvertise();\">\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(uv.getName() )?"---":uv.getName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(uv.getCompany() )?"---":uv.getCompany() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(uv.getWorkingPlace() )?"---":uv.getWorkingPlace() );
      out.write("</td>\r\n");
      out.write("               \t<td>");
      out.print(StringHelper.isEmpty(uv.getLinkman() )?"---":uv.getLinkman() );
      out.write("</td>\r\n");
      out.write("               \t");
      out.write("\r\n");
      out.write("\t\t\t\t<td>");
if(uv.getStatus().intValue()==0){
      out.write("\r\n");
      out.write("\t\t\t\t");
      out.print(DictionaryCache.getValueByCode(Dictionary.AUDIT_STATUS,uv.getStatus()+""));
      out.write("\r\n");
      out.write("\t\t\t\t<input type=\"button\" id=\"update\" name=\"update\" value=\"审核...\" class=\"mainoption\" \r\n");
      out.write("\t\t\t\tonClick=\"javascript:auditModelAdvertise(");
      out.print(uv.getId());
      out.write(',');
      out.print(count );
      out.write(");\">");
      ...
      out.write("\t\t\t\tonClick=\"javascript:reAuditModelAdvertise(");
      out.print(uv.getId());
      out.write(',');
      out.print(count );
      out.write(");\"></font>");
      ...
      out.write("&nbsp;</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(uv.getCreateTime());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(uv.getCreator() )?"---":uv.getCreator() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td align=\"left\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"查看招聘信息...\" onClick=\"javascript:queryModelAdvertise(");
      out.print(uv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"修改...\" onClick=\"javascript:prepareUpdateModelAdvertise(");
      out.print(uv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"删除...\" onClick=\"javascript:deleteModelAdvertise(");
      out.print(uv.getId());
      out.write(',');
      out.print(count );
      out.write(");\">\r\n");
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_auth_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(27,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f0.setTest("/admin/queryModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(27,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(31,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f1.setTest("/admin/prepareAddModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(31,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f2(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(35,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f2.setTest("/admin/prepareUpdateModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(35,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f3(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(39,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f3.setTest("/admin/auditModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(39,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f4(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(47,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f4.setTest("/admin/reAuditModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(47,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f5(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(54,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f5.setTest("/admin/deleteModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(54,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f6(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(77,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f6.setTest("/admin/updateAllModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(77,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f7(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(96,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f7.setTest("/admin/reUpdateAllModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(96,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f8(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(115,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f8.setTest("/admin/deleteAllModelAdvertise.do");
    // /admin/chinese/modelAdvertisePage.jsp(115,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(134,21) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(135,19) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(149,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f2(PageContext _jspx_page_context)
    ...
    // /admin/chinese/modelAdvertisePage.jsp(152,52) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
