...
public final class modelPeriodicalPageEn_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	List modelProductCategoryStatus = (List)request.getAttribute("modelProductCategoryStatus");
      ...
      out.write("\t\tform.action = \"modelPeriodicalEnPage.do?typeId=");
      if (_jspx_meth_ww_005fproperty_005f1(_jspx_page_context))
        return;
      out.write("\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction prepareUpdateModelPeriodical(id){\r\n");
      out.write("\t\t");
      if (_jspx_meth_auth_005fif_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateModelPeriodicalEn.do?id=\"+id+\"&typeName=");
      ...
      if (_jspx_meth_auth_005fif_005f1(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareAddModelPeriodicalEn.do?typeId=");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleteModelPeriodical(id,pageId){\r\n");
      out.write("\t\t");
      ...
      out.write("\t\tvar url =\"deleteModelPeriodicalEn.do?id=\"+id;\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction auditModelPeriodical(id,pageId){\r\n");
      out.write("\t\t");
      ...
      out.write("\t\tvar url = 'auditModelPeriodicalEn.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction reAuditModelPeriodical(id,pageId){\r\n");
      out.write("\t\t");
      ...
      out.write("\t\tvar params = 'id='+id;\r\n");
      out.write("\t\tvar url = 'reAuditModelPeriodicalEn.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\tvar params = '';\r\n");
      out.write("\t\t\tvar url = 'auditAllModelPeriodicalEn.do?ShenHeId='+ary;\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      out.write("\t   \r\n");
      ...
      out.write("\t\t\tvar params = '';\r\n");
      out.write("\t\t\tvar url = 'reAuditAllModelPeriodicalEn.do?ShenHeId='+ary;\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      ...
      out.write("\t\t\tvar url = 'deleteAllModelPeriodicalEn.do';\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      ...
      if (_jspx_meth_auth_005fif_005f8(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"modelPeriodicalCenterEnPage.do?periodicalId=\"+categoryId,\"电子期刊内容管理\",950,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
...
for(Iterator it = modelProductCategoryStatus.iterator();it.hasNext();){
      ...
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" name=\"addmp\" value=\"新增电子期刊\" class=\"mainoption\" onClick='javascript:prepareAddModelPeriodica()'>\r\n");
  	...
  	if(pages != null && pages.getTotalCount() > 0){
		...
		if(pageNumber>1){
	  	...
	  	for(Iterator it = pages.iterator();it.hasNext();){
	  	    count++;
			showCount++;
	  		ModelPeriodicalEnView mpv = (ModelPeriodicalEnView)it.next();
...
if(mpv.getStatus().intValue()==0){
      ...
      out.write("\t\t\t\tonClick=\"javascript:auditModelPeriodical(");
      out.print(mpv.getId());
      out.write(',');
      out.print(count);
      out.write(");\">");
      ...
      out.write("\t\t\t\tonClick=\"javascript:reAuditModelPeriodical(");
      out.print(mpv.getId());
      out.write(',');
      out.print(count);
      out.write(");\"></font>");
      ...
      out.write("\t\t\t\t<input type=\"button\" value=\"修改...\" onClick=\"javascript:prepareUpdateModelPeriodical(");
      out.print(mpv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"删除...\" onClick=\"javascript:deleteModelPeriodical(");
      out.print(mpv.getId());
      out.write(',');
      out.print(count);
      out.write(");\">\r\n");
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(16,7) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(22,49) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f1.setValue("typeId");
  ...
  private boolean _jspx_meth_auth_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(26,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f0.setTest("/admin/prepareUpdateModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(26,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f2(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(27,70) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f3(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(27,107) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(31,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f1.setTest("/admin/prepareAddModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(31,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f4(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(32,55) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f4.setValue("typeId");
  ...
  private boolean _jspx_meth_ww_005fproperty_005f5(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(32,89) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f2(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(36,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f2.setTest("/admin/deleteModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(36,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f3(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(46,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f3.setTest("/admin/auditModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(46,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f4(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(54,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f4.setTest("/admin/reAuditModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(54,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f6(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(62,21) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f7(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(67,49) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f7.setValue("typeId");
  ...
  private boolean _jspx_meth_auth_005fif_005f5(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(86,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f5.setTest("/admin/auditAllModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(86,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f6(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(106,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f6.setTest("/admin/reAuditAllModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(106,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f7(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(125,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f7.setTest("/admin/deleteAllModelPeriodicalEn.do");
    // /admin/english/modelPeriodicalPageEn.jsp(125,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f8(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(144,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f8.setTest("/admin/modelPeriodicalCenterEnPage.do");
    // /admin/english/modelPeriodicalPageEn.jsp(144,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f8(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(150,72) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(153,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f9(PageContext _jspx_page_context)
    ...
    // /admin/english/modelPeriodicalPageEn.jsp(157,58) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_ww_005fif_005f0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  ww:property
    ...
    _jspx_th_ww_005fproperty_005f10.setValue("responseMessage");
  ...
  private boolean _jspx_meth_ww_005fproperty_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_ww_005fif_005f1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  ww:property
