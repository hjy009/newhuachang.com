...
public final class modelApplyforPageEn_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	List statusList = (List)request.getAttribute("statusList");
      ...
      out.write("\t\tform.action = \"modelApplyforEnPage.do\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction queryModelAdvertise(id){\r\n");
      out.write("\t\tif(openDialog(\"queryModelApplyforEn.do?id=\"+id,\"查看应聘信息\",550,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tvar url = 'deleteModelApplyforEn.do';\r\n");
      ...
      out.write("\t\twindow.location.href=\"downloadFilesApplyforEn.do?id=\"+id;\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<table width=\"96%\" align=\"center\" border=\"0\"><tr><td><div class=\"title\">应聘信息管理</div></td></tr></table>\r\n");
  	...
  	if(pages != null && pages.getTotalCount() > 0){
		...
		if(pageNumber>1){
	  	...
	  	for(Iterator it = pages.iterator();it.hasNext();){
	  	    count++;
	  	    showCount++;
	  		ModelApplyforEnView mac = (ModelApplyforEnView)it.next();
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(mac.getName() )?"---":mac.getName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(mac.getAppliedPosition() )?"---":mac.getAppliedPosition());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(mac.getMemberEnterprises() )?"---":mac.getMemberEnterprises() );
      out.write("</td>\r\n");
      out.write("               \t<td>");
      out.print(StringHelper.isEmpty(mac.getWorkExperience() )?"---":mac.getWorkExperience() );
      out.write("</td>\r\n");
      out.write("               \t");
      out.write("\r\n");
      out.write("               \t<td>\r\n");
      out.write("               \t\t");
      out.print(StringHelper.isEmpty(mac.getTablePath() )?"---":mac.getTablePath() );
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<input type=\"button\" value=\"查看应聘信息...\" onClick=\"javascript:queryModelAdvertise(");
      out.print(mac.getId());
      out.write(");\">\r\n");
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_auth_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelApplyforPageEn.jsp(31,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f0.setTest("/admin/deleteModelApplyforEn.do");
    // /admin/english/modelApplyforPageEn.jsp(31,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelApplyforPageEn.jsp(54,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f1.setTest("/admin/deleteAllModelApplyforEn.do");
    // /admin/english/modelApplyforPageEn.jsp(54,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f2(PageContext _jspx_page_context)
    ...
    // /admin/english/modelApplyforPageEn.jsp(81,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f2.setTest("/admin/downloadFilesApplyforEn.do");
    // /admin/english/modelApplyforPageEn.jsp(81,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelApplyforPageEn.jsp(91,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelApplyforPageEn.jsp(94,52) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
