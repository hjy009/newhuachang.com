...
public final class modelNewsPageEn_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	List modelNewsStatus = (List)request.getAttribute("modelNewsStatus");
      ...
      out.write("\t\tform.action = \"modelNewsPageEn.do?centerId=");
      if (_jspx_meth_ww_005fproperty_005f0(_jspx_page_context))
        return;
      out.write("\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction prepareUpdateModelNews(id){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateModelNewsEn.do?id=\"+id,\"修改新闻发布\",850,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareAddModelNews(){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f1(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareAddModelNewsEn.do?centerId=");
      if (_jspx_meth_ww_005fproperty_005f1(_jspx_page_context))
        return;
      out.write("\",\"新增新闻发布\",850,300)==\"SUCCESS\")refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleteModelNews(id,pageId){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f2(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(confirm('是否删除此ID：['+pageId+']？删除后将找不回此新闻关联的历史记录')==false){\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar params = '';\r\n");
      out.write("\t\tvar url =\"deleteModelNewsEn.do?id=\"+id;\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction auditModelNews(id,pageId){\r\n");
      out.write("\t");
      ...
      out.write("\t\tvar url = 'auditModelNewsEn.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction reAuditModelNews(id,pageId){\r\n");
      out.write("\t");
      ...
      out.write("\t\tvar params = 'id='+id;\r\n");
      out.write("\t\tvar url = 'reAuditModelNewsEn.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\talert(\"至少选择一个新闻进行审核\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(confirm(\"是否批量审核您所选的选项？\") == false) return ;\r\n");
      out.write("\t\t\tvar params = '';\r\n");
      out.write("\t\t\tvar url = 'auditAllModelNewsEn.do?ShenHeId='+ary;\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      out.write("\t   \r\n");
      ...
      out.write("\t\t\tvar params = '';\r\n");
      out.write("\t\t\tvar url = 'reAuditAllModelNewsEn.do?ShenHeId='+ary;\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      out.write("\t   \r\n");
      ...
      out.write("\t\t    }\r\n");
      out.write("\t\t    if(ary.length<1) {\r\n");
      out.write("\t\t\t\talert(\"至少选择一个新闻进行删除\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(confirm(\"是否批量删除您所选的选项？删除后将找不回新闻关联的历史记录\") == false) return ;\r\n");
      out.write("\t\t\tvar params = 'ShenHeId='+ary;\r\n");
      out.write("\t\t\tvar url = 'deleteAllModelNewsEn.do';\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      out.write("\t   \r\n");
      out.write("\tfunction modelNewsHistoryPage(newsId,newsTitle){\r\n");
      out.write("\t\t");
      if (_jspx_meth_auth_005fif_005f8(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"modelNewsHistoryPageEn.do?newsId=\"+newsId+\"&newsTitle=\"+newsTitle,\"新闻历史管理\",950,300)==\"SUCCESS\")refresh();\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<table width=\"96%\" align=\"center\" border=\"0\"><tr><td><div class=\"title\">新闻发布管理</div></td></tr></table>\r\n");
      ...
      if (_jspx_meth_ww_005ftextfield_005f0(_jspx_page_context))
        return;
      out.write("<img src='/images/admin/calendar.gif' alt='点击选择日期' border='0' align='absmiddle' style=\"cursor:hand\" onClick=\"return showCalendar('startTime');\">\r\n");
      out.write("\t\t\t到：");
      if (_jspx_meth_ww_005ftextfield_005f1(_jspx_page_context))
        return;
      out.write("<img src='/images/admin/calendar.gif' alt='点击选择日期' border='0' align='absmiddle' style=\"cursor:hand\" onClick=\"return showCalendar('endTime');\">\r\n");
      out.write("\t\t\t&nbsp;标题：<input id=\"title\" name=\"title\" size=\"15\" value=\"");
...
for(Iterator it = modelNewsStatus.iterator();it.hasNext();){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t </select>\t\r\n");
      out.write("\t\t\t<!-- &nbsp;排序：<select id=\"sequence\" name=\"sequence\">\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"\">不排序</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"0\">顺序排序</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"1\">降序排序</option>\r\n");
      out.write("\t\t\t\t\t\t</select>-->\r\n");
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" name=\"search\" value=\" 查 询 \" class=\"mainoption\" onClick=\"javascript:go2Page(1);\">\r\n");
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" name=\"addmp\" value=\"新增新闻发布...\" class=\"mainoption\" onClick=\"javascript:prepareAddModelNews();\">\r\n");
  	...
  	if(pages != null && pages.getTotalCount() > 0){
		...
		if(pageNumber>1){
	  	...
	  	for(Iterator it = pages.iterator();it.hasNext();){
	  	    count++;
			showCount++;
	  		ModelNewsEnView sgv = (ModelNewsEnView)it.next();
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(sgv.getTitle())?"---":sgv.getTitle());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
if(sgv.getStatus().intValue()==0){
      ...
      out.write("\t\t\t\tonClick=\"javascript:auditModelNews(");
      out.print(sgv.getId());
      out.write(',');
      out.print(count);
      out.write(");\">");
      ...
      out.write("\t\t\t\tonClick=\"javascript:reAuditModelNews(");
      out.print(sgv.getId());
      out.write(',');
      out.print(count);
      out.write(");\"></font>");
      ...
      out.write("\t\t\t\t<input type=\"button\" value=\"修改...\" onClick=\"javascript:prepareUpdateModelNews(");
      out.print(sgv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"删除...\" onClick=\"javascript:deleteModelNews(");
      out.print(sgv.getId());
      out.write(',');
      out.print(count);
      out.write(");\">\r\n");
      out.write("\t\t\t<!-- \t<input type=\"button\" value=\"历史...\" onClick=\"javascript:modelNewsHistoryPage(");
      out.print(sgv.getId());
      out.write(',');
      out.write('\'');
      out.print(sgv.getTitle());
      out.write("');\"> -->\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t  </tr>\r\n");
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(22,45) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(26,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f0.setTest("/admin/prepareUpdateModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(26,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(31,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f1.setTest("/admin/prepareAddModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(31,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(32,51) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f1.setValue("centerId");
  ...
  private boolean _jspx_meth_auth_005fif_005f2(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(36,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f2.setTest("/admin/deleteModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(36,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f3(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(46,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f3.setTest("/admin/auditModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(46,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f4(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(54,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f4.setTest("/admin/reAuditModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(54,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f2(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(62,21) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f2.setValue("status");
  ...
  private boolean _jspx_meth_ww_005fproperty_005f3(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(63,23) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f3.setValue("sequence");
  ...
  private boolean _jspx_meth_ww_005fproperty_005f4(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(68,45) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f4.setValue("centerId");
  ...
  private boolean _jspx_meth_auth_005fif_005f5(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(87,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f5.setTest("/admin/auditAllModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(87,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f6(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(107,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f6.setTest("/admin/reAuditAllModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(107,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f7(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(127,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f7.setTest("/admin/deleteAllModelNewsEn.do");
    // /admin/english/modelNewsPageEn.jsp(127,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f8(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(147,2) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f8.setTest("/admin/modelNewsHistoryPageEn.do");
    // /admin/english/modelNewsPageEn.jsp(147,2) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(156,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005ftextfield_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(159,13) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005ftextfield_005f0.setName("'startTime'");
    // /admin/english/modelNewsPageEn.jsp(159,13) name = id type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005ftextfield_005f0.setId("'startTime'");
    // /admin/english/modelNewsPageEn.jsp(159,13) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005ftextfield_005f0.setSize("'9'");
    // /admin/english/modelNewsPageEn.jsp(159,13) name = maxlength type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005ftextfield_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(160,5) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005ftextfield_005f1.setName("'endTime'");
    // /admin/english/modelNewsPageEn.jsp(160,5) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005ftextfield_005f1.setSize("'9'");
    // /admin/english/modelNewsPageEn.jsp(160,5) name = maxlength type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f5(PageContext _jspx_page_context)
    ...
    // /admin/english/modelNewsPageEn.jsp(161,60) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_ww_005fif_005f0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  ww:property
  ...
  private boolean _jspx_meth_ww_005fproperty_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_ww_005fif_005f1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  ww:property
    ...
    _jspx_th_ww_005fproperty_005f9.setValue("responseMessage");
