...
public final class modelCulturePageEn_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\tform.action = \"modelCultureEnPage.do\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction prepareUpdateModelCulture(id){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateModelCultureEn.do?id=\"+id,\"修改企业文化\",850,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareAddModelCulture(){\r\n");
      out.write("\t");
      if (_jspx_meth_auth_005fif_005f1(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\tif(openDialog(\"prepareAddModelCultureEn.do\",\"新增企业文化\",850,300)==\"SUCCESS\")refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleteModelCulture(id,pageId){\r\n");
      out.write("\t");
      ...
      out.write("\t\tvar url =\"deleteModelCultureEn.do?id=\"+id;\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction auditModelCulture(id,pageId){\r\n");
      out.write("\t");
      ...
      out.write("\t\tvar url = 'auditModelCultureEn.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction reAuditModelCulture(id,pageId){\r\n");
      out.write("\t");
      ...
      out.write("\t\tvar params = 'id='+id;\r\n");
      out.write("\t\tvar url = 'reAuditModelCultureEn.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t }\r\n");
      out.write("\t    if(ary.length<1){\r\n");
      out.write("\t  \t\talert(\"至少选择一个企业文化进行重审核\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(confirm(\"是否批量重审核您所选的选项 ？\") == false) return ;\r\n");
      out.write("\t\tvar params = 'ShenHeId='+ary;\r\n");
      out.write("\t\tvar url = 'reUpdateAllModelCultureEn.do';\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      out.write("\t   \r\n");
      out.write("\t   \r\n");
      ...
      out.write("\t\t    }\r\n");
      out.write("\t\t    if(ary.length<1) {\r\n");
      out.write("\t\t\t\talert(\"至少选择一个企业文化进行删除\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(confirm(\"是否批量删除您所选的选项 ？\") == false) return ;\r\n");
      out.write("\t\t\tvar params = 'ShenHeId='+ary;\r\n");
      out.write("\t\t\tvar url = 'deleteAllModelCultureEn.do';\r\n");
      out.write("\t\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t   }\r\n");
      out.write("\t   \r\n");
      out.write(" \r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<table width=\"96%\" align=\"center\" border=\"0\"><tr><td><div class=\"title\">企业文化管理</div></td></tr></table>\r\n");
      ...
      out.write("\t\t\t名称：<input id=\"name\" name=\"name\" size=\"11\" value=\"");
...
for(Iterator it = statusList.iterator();it.hasNext();){
      ...
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" name=\"addmp\" value=\"新增企业文化...\" class=\"mainoption\" onClick=\"javascript:prepareAddModelCulture();\">\r\n");
    	...
    	if(pages.getPageCount()>1&&pages.getPageCount()>=pageNumber){
    		...
    		count = (pageNumber-2)*pageMaxSize;
    	  	...
    	  	for(Iterator it = pages.iterator();it.hasNext();){
    	  	    count++;
    	  	    showCount++;
    	  		ModelCultureEnView miv = (ModelCultureEnView)it.next();
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(miv.getName())?"---":miv.getName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(miv.getContent() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(miv.getSequence());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
if(miv.getStatus().intValue()==0){
      out.write("\r\n");
      out.write("\t\t\t\t");
      out.print(DictionaryCache.getValueByCode(Dictionary.AUDIT_STATUS,miv.getStatus()+""));
      out.write("\r\n");
      out.write("\t\t\t\t<input type=\"button\" id=\"update\" name=\"update\" value=\"审核...\" class=\"mainoption\" \r\n");
      out.write("\t\t\t\tonClick=\"javascript:auditModelCulture(");
      out.print(miv.getId());
      out.write(',');
      out.print(count );
      out.write(");\">");
      ...
      out.write("\t\t\t\tonClick=\"javascript:reAuditModelCulture(");
      out.print(miv.getId());
      out.write(',');
      out.print(count );
      out.write(");\"></font>");
      ...
      out.write("&nbsp;</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(miv.getCreateTime());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(miv.getCreator());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td align=\"left\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"修改...\" onClick=\"javascript:prepareUpdateModelCulture(");
      out.print(miv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input id=\"answerButton\" type=\"button\" value=\"删除...\" onClick=\"javascript:deleteModelCulture(");
      out.print(miv.getId());
      out.write(',');
      out.print(count );
      out.write(");\">\r\n");
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_auth_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(28,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f0.setTest("/admin/prepareUpdateModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(28,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(33,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f1.setTest("/admin/prepareAddModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(33,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f2(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(38,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f2.setTest("/admin/deleteModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(38,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f3(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(48,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f3.setTest("/admin/auditModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(48,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f4(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(56,1) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f4.setTest("/admin/reAuditModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(56,1) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(64,21) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f5(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(88,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f5.setTest("/admin/updateAllModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(88,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f6(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(106,5) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f6.setTest("/admin/reUpdateAllModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(106,5) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_auth_005fif_005f7(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(126,4) name = test type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_auth_005fif_005f7.setTest("/admin/deleteAllModelCultureEn.do");
    // /admin/english/modelCulturePageEn.jsp(126,4) name = status type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(152,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /admin/english/modelCulturePageEn.jsp(155,52) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
