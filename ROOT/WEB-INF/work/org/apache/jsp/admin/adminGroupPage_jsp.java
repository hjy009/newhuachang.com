...
public final class adminGroupPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	Pagination pages = (Pagination)request.getAttribute("pages");
      ...
      out.write("\t\tform.action = \"adminGroupPage.do\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareAddAdminGroup(){\r\n");
      out.write("\t\tif(openDialog(\"prepareAddAdminGroup.do\",\"新增角色\",450,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareUpdateAdminGroup(id){\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateAdminGroup.do?id=\"+id,\"修改角色信息\",450,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleteAdminGroup(id,name){\r\n");
      out.write("\t\tif(confirm('是否删除此角色[角色名称:'+name+']?')==false){\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar params = '';\r\n");
      out.write("\t\tvar url =\"deleteAdminGroup.do?id=\"+id;\r\n");
      out.write("\t\tnew Ajax.Request( url, { method: 'get', parameters: params, onComplete: commonReponse });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction groupRoleList(groupId){\r\n");
      out.write("\t\tif(openDialog(\"groupRoleList.do?groupId=\"+groupId,\"分配权限\",650,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<table width=\"96%\" align=\"center\" border=\"0\"><tr><td><div class=\"title\">角色管理</div></td></tr></table>\r\n");
      ...
      out.write("\t\t\t&nbsp;角色名称：<input id=\"name\" name=\"name\" size=\"15\" value=\"");
      ...
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" id=\"add\" name=\"add\" value=\"新增角色...\" class=\"mainoption\" onClick=\"prepareAddAdminGroup();\">\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t  </tr>\r\n");
      out.write("\t</form>\r\n");
      out.write("</table>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(agv.getName())?"---":agv.getName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(agv.getRemark())?"---":agv.getRemark());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(agv.getCreateTime());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(agv.getCreator());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"><input type=\"button\" value=\"权限分配...\" onClick=\"javascript:groupRoleList(");
      out.print(agv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"修改...\" onClick=\"javascript:prepareUpdateAdminGroup(");
      out.print(agv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"删除...\" onClick=\"javascript:deleteAdminGroup(");
      out.print(agv.getId());
      out.write(',');
      out.write('\'');
      out.print(agv.getName());
      out.write("');\"></td>\r\n");
      out.write("\t\t\t  </tr>\r\n");
      out.write("\t");
      ...
      out.write("\t\t\t    <td colspan=\"6\" height=\"50\">无相关数据</td>\r\n");
      out.write("\t\t\t  </tr>\r\n");
      out.write("  ");
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/adminGroupPage.jsp(58,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/adminGroupPage.jsp(61,60) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
