...
public final class rolePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	List typeList = (List)request.getAttribute("typeList");
      ...
      out.write("\t\tform.action = \"rolePage.do\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareAddRole(){\r\n");
      out.write("\t\tif(openDialog(\"prepareAddRole.do\",\"新增权限\",450,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction prepareUpdateRole(id){\r\n");
      out.write("\t\tif(openDialog(\"prepareUpdateRole.do?id=\"+id,\"修改权限信息\",450,300) ==\"SUCCESS\") refresh();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleteRole(id,name){\r\n");
      out.write("\t\tif(confirm('是否删除此权限[权限名称:'+name+']?')==false){\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar params = '';\r\n");
      out.write("\t\tvar url =\"deleteRole.do?id=\"+id;\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<table width=\"96%\" align=\"center\" border=\"0\"><tr><td><div class=\"title\">权限管理</div></td></tr></table>\r\n");
      ...
      out.write("\t\t\t&nbsp;权限名称：<input id=\"name\" name=\"name\" size=\"15\" value=\"");
      if (_jspx_meth_ww_005fproperty_005f2(_jspx_page_context))
        return;
      out.write("\">\r\n");
      out.write("\t\t\t&nbsp;代码：<input id=\"code\" name=\"code\" size=\"15\" value=\"");
...
for(Iterator it = typeList.iterator();it.hasNext();){
      ...
      out.write("\t\t\t&nbsp;&nbsp;<input type=\"button\" id=\"add\" name=\"add\" value=\"新增权限...\" class=\"mainoption\" onClick=\"prepareAddRole();\">\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t  </tr>\r\n");
      out.write("\t</form>\r\n");
      out.write("</table>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(rv.getName())?"---":rv.getName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(rv.getCode())?"---":rv.getCode());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(DictionaryCache.getValueByCode(Dictionary.ROLE_TYPE,rv.getType()+""));
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(rv.getSequence());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(StringHelper.isEmpty(rv.getDescription())?"---":rv.getDescription());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(rv.getCreateTime());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td>");
      out.print(rv.getCreator());
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"><input type=\"button\" value=\"修改...\" onClick=\"javascript:prepareUpdateRole(");
      out.print(rv.getId());
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"删除...\" onClick=\"javascript:deleteRole(");
      out.print(rv.getId());
      out.write(',');
      out.write('\'');
...
if(pages != null && !pages.isEmpty()){
  ...
  private boolean _jspx_meth_ww_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /admin/rolePage.jsp(49,19) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f0.setValue("type");
  ...
  private boolean _jspx_meth_ww_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /admin/rolePage.jsp(50,20) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f1.setValue("order");
  ...
  private boolean _jspx_meth_ww_005fhidden_005f0(PageContext _jspx_page_context)
    ...
    // /admin/rolePage.jsp(59,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f2(PageContext _jspx_page_context)
    ...
    // /admin/rolePage.jsp(62,60) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ww_005fproperty_005f3(PageContext _jspx_page_context)
    ...
    // /admin/rolePage.jsp(63,58) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ww_005fproperty_005f3.setValue("code");
