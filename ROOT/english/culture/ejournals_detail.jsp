...
<div class="wrap4">
  ...
  <div class="cls"></div>
    ...
    <ul class="arrlist ip_ns_ul">
     ...
     <script type="text/javascript" src="/english/js/jquery-1.7.min.js"></script>
     <script type="text/javascript" src="/english/js/jquery.SuperSlide.js" language="javascript"></script>
