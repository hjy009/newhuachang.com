  		...
  		<div class="mleft">
            ...
            <div class="mleftbox">
            	<ul class="leftlist1">
                        ...
                        <li><a  class="hover" href="/english/cultureByEnterpriseWebEn.do?id=33">Spirit and Attitude</a></li>
                        		...
                        		<ul>
                       				<%
                       				 ...
                       				 <li onclick="setTab22('ddd1','ppp1')" id="ppp1">
                       				 	<a href="/english/queryEjournalsEn.do?typeId=<%=mptMap.get("id") %>"><%=mptMap.get("name")%> <%=mptMap.get("id") %></a>
				                     </li>
                       				<%} %>
                       				<%} %>
                        		</ul>
