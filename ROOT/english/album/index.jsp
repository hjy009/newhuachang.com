...
<script language="javascript">
	function gotoPage(pno){
		url = "/english/queryAlbumTypeEn.do";
...
<div class="footbg">
  <div class="wrap">
    ...
    <div class="mmain">
        ...
        <div class="mleftbox">
          <ul class="leftlist1">
              		 <%--
                        ...
                        <li><a class="hover" href="queryAlbumTypeEn.do">E-Brochure</a></li>
      ...
      <!-- mright -->
      <div class="mright">
        <div class="curr"> Your location-<a href="/english/cultureWebEn.do?id=29">Company Culture</a>-E-Brochure </div>
        <div class="mtitle">
          <h2>E-Brochure</h2>
        </div>
        <div class="ejournals">
          <ul>
          	...
          	%>
            <li <%if(i==2||i==5){ %> class="li3d" <%}%> ><a href="queryAlbumEn.do?typeId=<%=map.get("id") %>" target="_blank">
           	 <img class="ebook" src="/<%=map.get("image_path") %>" width="179" height="244" /></a><a class="ebookname" href="queryAlbumEn.do?typeId=<%=map.get("id") %>" target="_blank"><span>◇</span> <%=map.get("name") %></a></li>
