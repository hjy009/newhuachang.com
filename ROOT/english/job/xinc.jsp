...
<!--     <a href="/english/queryRecruitEn.do">Job Opportunity</a>   -->  
  ...
  <div class="mmain">
  		<div class="mleft">
            ...
            <div class="mleftbox">
            	<ul class="leftlist">
                        ...
                        <li class="hover"><a href="/english/queryXincEn.do">Compensation and Benefits</a></li>
    ...
    <!-- mright -->
    	<div class="mright">
        		 <div class="curr">
                 	Your location-<a href="/english/queryEmployessEn.do">Staffs and Recruitment </a>-Compensation and Benefits
