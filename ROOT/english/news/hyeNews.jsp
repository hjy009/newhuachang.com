...
<script language="javascript">
	function gotoPage(pno){
		url = "/english/queryHyeNewsEn.do?pageNumber="+pno+"&years=<ww:property value='years'/>";
    ...
    <!-- mright -->
    	<div class="mright">
                 ...
                 <%if(list!=null&&list.size()>0){%>
						...
						%>
                    	<li>
		                    <p class="pli"><span><%=map.get("click")%> time </span><a href="queryHyeNewsDetailEn.do?newsId=<%=map.get("id")%>#mright" ><%=NewStringHelper.truncate((String)map.get("title"),60,"...")%></a></p>
