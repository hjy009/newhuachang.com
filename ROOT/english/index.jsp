          ...
          <DIV class=scroll>
            ...
            <DIV id=arrCont_01 class=arrCont>
              <ul class="arrlist">
          		 ...
          		 %>
                <li> <span class="l"><%=map.get("name") %></span> <span class="r"><a href="/english/queryProductEn.do?categoryId=1"><img src="/<%=map.get("small_image") %>" width="87" height="58" /></a></span> </li>
            ...
            <DIV id=arrCont_02 class=arrCont>
              <ul class="arrlist">
                <%
          		 ...
          		 %>
                <li> <span class="l"><%=map.get("name") %></span> <span class="r"><a href="/english/querySpeciaIndexEn.do?categoryId=4"><img src="/<%=map.get("small_image") %>" width="87" height="58" /></a></span> </li>
            ...
            <DIV id=arrCont_03 class=arrCont>
              <ul class="arrlist">
                <%
          		 ...
          		 %>
                <li> <span class="l"><%=map.get("name") %></span> <span class="r"><a href="/english/queryPottypeIndexEn.do?categoryId=10"><img src="/<%=map.get("small_image") %>" width="87" height="58" /></a></span> </li>
