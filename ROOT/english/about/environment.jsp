...
<script language="javascript">
	function gotoPage(pno){
		url = "/english/queryFactoryEnvironmentEn.do?pageNumber="+pno;
    ...
    <!-- mright -->
    	<div class="mright">
                 ...
                 <div class="mcon3" id="right">
						...
						%>
                    	 <li  <%if(i % 3 == 0){ %><%}else{ %>style="margin-right:0;"<%} %>  ><a href="queryFactoryEnvironmentDetailEn.do?factoryId=<%=map.get("id") %>#right"><img src="/<%=map.get("min_image") %>" width="209" height="139" /><span>See</span></a></li>
						<%}%>
		  				<%}else{%>
		  				ÔÝÎÞ
		  				<%}%>
