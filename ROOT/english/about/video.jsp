...
<script language="javascript">
	function gotoPage(pno){
		url = "/english/videoWebEn.do?pageNumber="+pno;
...
<div class="wrap">
  ...
  <div class="mmain">
  		<div class="mleft">
            ...
            <div class="mleftbox">
            	<ul class="leftlist">
                    	...
                    	<li  class="hover"><a href="/english/videoWebEn.do">Company Sight</a></li>
                </ul>
    ...
    <!-- mright -->
    	<div class="mright">
        		 <div class="curr">
                 	Your location-<a href="/english/introWebEn.do">About us</a>-Company Sight
                 ...
                 <div class="mcon3">
                  ...
                  <ul class="videolist">
                  			...
                  			<%if(list!=null&&list.size()>0){%>
								...
								%><li>
								<a href="/english/videoDetaiWebEn.do?id=<%=map.get("id") %>"><img src="/<%=map.get("image_path") %>" width="172" height="121" /></a>
