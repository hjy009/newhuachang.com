...
<script language="javascript">
	function gotoPage(pno){
		url = "/english/querySpeciaIndexEn.do?categoryId=4&pageNumber="+pno;
...
<div class="wrap">
  ...
  <div class="mmain">
            	...
            	<ul class="leftlist">
                    	...
                    	<li class="hover"><a href="/english/queryProductEn.do?categoryId=1">Main Products</a>
                        		...
                        		<ul>
									...
									<li class="hover"><a href="/english/querySpeciaIndexEn.do?categoryId=4">Special Containers</a></li>  
    ...
    <!-- mright -->
    	<div class="mright">
        		 <div class="curr">
                 	Your location-<a href="/english/queryProductEn.do?categoryId=1">Main Products</a>-Special Containers
