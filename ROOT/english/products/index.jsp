...
<script language="javascript">
	function gotoPage(pno){
		url = "/english/queryProductEn.do?pageNumber="+pno+"&categoryId=1";
 ...
 <jsp:include flush="true" page="/english/head.jsp" ></jsp:include>
  ...
  <div class="mmain">
  		<div class="mleft">
            ...
            <div class="mleftbox"  style="border-collapse:collapse; ">
            	<ul class="leftlist">
                        ...
                        <li><a href="/english/queryCategoryByIdEn.do?categoryId=11&productName=船运公司">Customers</a></li>
    ...
    <!-- mright -->
    	<div class="mright">
        		 <div class="curr">
                 	Your location-<a href="/english/queryProductEn.do?categoryId=1">Main Products</a>-ISO Standard Containers
                 
                 </div>
                 
                 <div class="mtitle">
                 <h2> ISO Standard Containers</h2>
                 </div>
