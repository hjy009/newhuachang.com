...
<script language="javascript">
	function gotoPage(pno){
		url = "/chinese/queryQiyeNews.do?pageNumber="+pno+"&years=<ww:property value='years'/>";
 ...
 <%if(imageList!=null&&imageList.size()>0){
  ...
  <div class="mmain">
  		<div class="mleft">
            ...
            <div class="mleftbox">
            	<ul class="leftlist">
                    	...
                    	<li class="hover"><a href="/chinese/queryQiyeNews.do">企业新闻</a></li>
                        <li><a href="/chinese/queryHyeNews.do">行业新闻</a></li>
    ...
    <!-- mright -->
    	<div class="mright">
        		 <div class="curr">
                 	您的位置-<a href="/chinese/queryQiyeNews.do">新闻中心</a>-企业新闻
                 ...
                 <%if(list!=null&&list.size()>0){%>
						...
						%>
                    	<li>
		                    <p class="pli"><span><%=map.get("click")%>次</span><a href="queryQiyeNewsDetail.do?newsId=<%=map.get("id")%>" ><%=NewStringHelper.truncate((String)map.get("title"),60,"...")%></a></p>
