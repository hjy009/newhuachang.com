...
<div class="wrap">
  ...
  <div class="nav">
    <ul class="navlist">
      ...
      <li class="hover"><a href="/chinese/cultureWeb.do?id=29">企业文化</a></li>
  		...
  		<div class="mleft">
            ...
            <div class="mleftbox">
            	<ul class="leftlist1">          
                        ...
                        <li><a class="hover" href="/chinese/cultureWeb.do?id=29">集团纲领</a></li>
                        ...
                        <li ><a href="/chinese/cultureByDutyWeb.do?id=35">社会责任</a></li>
                   		<li><a href="/chinese/cultureByDutyWeb.do?id=35">愿景与使命</a></li>
