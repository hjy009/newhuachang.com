  		...
  		<div class="mleft">
            ...
            <div class="mleftbox">
            	<ul class="leftlist1">
                        ...
                        <li><a class="hover" href="/chinese/cultureByEnterpriseWeb.do?id=33">精神与作风</a></li>
                        		...
                        		<ul>
                       				<%
                       				 ...
                       				 <li onclick="setTab22('ddd1','ppp1')" id="ppp1">
                       				 	<a href="/chinese/queryEjournals.do?typeId=<%=mptMap.get("id") %>"><%=mptMap.get("name")%> <%=mptMap.get("id") %></a>
				                     </li>
                       				<%} %>
                       				<%} %>
                        		</ul>
