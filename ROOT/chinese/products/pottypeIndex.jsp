...
<script language="javascript">
	function gotoPage(pno){
		url = "/chinese/queryPottypeIndex.do?categoryId=10&pageNumber="+pno;
...
<div class="wrap">
  ...
  <div class="mmain">
            	...
            	<ul class="leftlist">
                    	...
                    	<li class="hover"><a href="/chinese/queryProduct.do?categoryId=1">主要产品</a>
                        		...
                        		<ul>
									...
									<li class="hover"><a href="/chinese/queryPottypeIndex.do?categoryId=10">罐式集装箱</a></li> 
                                </ul>
    ...
    <!-- mright -->
    	<div class="mright">
        		 <div class="curr">
                 	您的位置-<a href="/chinese/queryProduct.do?categoryId=1">主要产品</a>-罐式集装箱
