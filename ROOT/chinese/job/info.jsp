...
<script language="javascript">
	function gotoPage(pno){
		url = "/chinese/queryZhaop.do?pageNumber="+pno+"&company=<ww:property value="company"/>&adName=<ww:property value="adName"/>&dataName=<ww:property value="dataName"/>";
...
<div class="wrap">
  ...
  <div class="mmain">
  		<div class="mleft">
            ...
            <div class="mleftbox">
            	<ul class="leftlist">
                        ...
                        <li class="hover"><a href="/chinese/queryZhaop.do">招聘信息</a></li>
    ...
    <!-- mright -->
    	<div class="mright">
        		 <div class="curr">
                 	您的位置-<a href="/chinese/queryEmployess.do">员工与招聘</a>-招聘信息
