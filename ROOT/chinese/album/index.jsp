...
<div class="footbg">
  <div class="wrap">
    ...
    <a href="/chinese/cultureByCustomerWeb.do?id=34">电子画册</a>      
    ...
    <div class="mmain">
        ...
        <div class="mleftbox">
          <ul class="leftlist1">
              		 <%--
                        ...
                        <li><a  class="hover" href="queryAlbumType.do">电子画册</a></li>
      ...
      <!-- mright -->
      <div class="mright">
        <div class="curr"> 您的位置-<a href="/chinese/cultureWeb.do?id=29">企业文化</a>-电子画册 </div>
        <div class="mtitle">
          <h2>电子画册</h2>
        </div>
        <div class="ejournals">
