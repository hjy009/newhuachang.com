...
<title>新增<ww:property value='categoryName'/></title>
...
<body>
<table width="96%" align="center" border="0"><tr><td><div class="title">新增<ww:property value='categoryName'/></div></td></tr></table>
...
<table width="98%" border="0" cellspacing="0" style="border:0;">
	<tr align="center" style="border:0;">
		<td style="border:0;" align="center">
		  ...
		  <input id="submitButton" type="button" value="新 增"  onclick="addModelProduct()">
		</td>
	</tr>
</table>
