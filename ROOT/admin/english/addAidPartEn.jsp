...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  ...
  <tr>
  	...
  	<td>&nbsp;<input id="sequence" name="aidpartEn.sequence" value="<ww:if test='sequence==1'>1</ww:if><ww:elseif test='aidpartEn.sequence!=1'><ww:property value='aidpartEn.sequence'/></ww:elseif>" size="30"><font color="#FF0000">*注意:此框只能输入数字，顺序应从1开始，发布日期相同时,数字越大排越后</font></td>
  </tr>
</form>
</table>
