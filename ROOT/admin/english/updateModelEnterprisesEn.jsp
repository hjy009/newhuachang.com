...
<script>
	...
	<auth:if test="/admin/updateModelEnterprisesEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		...
		form.action = "updateModelEnterprisesEn.do";
		form.submit();	
...
<ww:hidden name="'id'"></ww:hidden>
 <tr>
  ...
  <tr>
     ...
     <td>
     	<textarea rows="7" cols="80" id="remarks" name="modelEnterprisesEn.remarks" ><ww:property value="modelEnterprisesEn.remarks"/></textarea>
     </td>
