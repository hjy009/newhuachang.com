...
<body>
<table width="96%" align="center" border="0"><tr><td><div class="title">修改视频信息</div></td></tr></table>
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td>&nbsp;<input id="name" name="modelVideoEn.name" value="<ww:property value='modelVideoEn.name'/>" size="50">&nbsp;<font color="#FF0000">(名称不能超过30个文字)</font></td>
  </tr>
  <tr>
  ...
  <tr>
    <th>显示图片：</th>
    <td>&nbsp;<input type="file" id="fileSyImage" name="fileSyImage" value="<ww:property value='modelVideoEn.imagePath'/>" size="30"><br/>图片：<ww:property value='modelVideoEn.imagePath'/>
	<br><font color="#FF0000">(上传的图片只支持jpg,gif,bmp格式,大小不能超过500k)</font></td>
  </tr>
  <tr>
    <th>视频：</th>
    <td>&nbsp;<input type="file" id="fileImage" name="fileImage" value="<ww:property value='modelVideoEn.path'/>" size="30"><br/>视频：<ww:property value='modelVideoEn.path'/>
...
<table width="98%" border="0" cellspacing="0" style="border:0;">
	<tr align="center" style="border:0;">
		<td style="border:0;" align="center">
		  ...
		  <input id="submitButton" type="button" value="修 改"  onclick="updateModelVideo()">
		</td>
	</tr>
</table>
