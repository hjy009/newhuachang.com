...
<script language="javascript">
	...
	function prepareUpdateModelPublicationType(id){
		<auth:if test="/admin/prepareUpdateModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareUpdateModelPublicationTypeEn.do?id="+id+"&typeName=<ww:property value='typeName' />","修改<ww:property value='typeName' />分类",650,300) =="SUCCESS") refresh();
	}
	
	function prepareAddModelPeriodica(){
		<auth:if test="/admin/prepareAddModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareAddModelPublicationTypeEn.do","新增<ww:property value='typeName' />分类",650,200)=="SUCCESS")refresh();
	}
	
	function deleteModelPublicationType(id,pageId){
		<auth:if test="/admin/deleteModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	function auditModelPublicationType(id,pageId){
		<auth:if test="/admin/auditModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	function reAuditModelPublicationType(id,pageId){
		<auth:if test="/admin/reAuditModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	function   SelectAll(){      
	 var  aa = document.getElementsByName("productId");      
	   ...
	   function  shenhe(){
	   <auth:if test="/admin/auditAllModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   ...
	   function  reShenhe(){
	   <auth:if test="/admin/reAuditAllModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
	    ...
	    function  deleteAll(){
	   <auth:if test="/admin/deleteAllModelPublicationTypeEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
	   ...
	   function modelProductPage(categoryId){
		<auth:if test="/admin/modelPeriodicalEnPage.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("modelPeriodicalEnPage.do?typeId="+categoryId,"电子期刊内容管理",950,300) =="SUCCESS") refresh();
	}
</script>
</head>
<body>
