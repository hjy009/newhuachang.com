...
<script>
	...
	<auth:if test="/admin/updateModelContactEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		...
		form.action = "updateModelContactEn.do";
		form.submit();	
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  <input type="hidden" id="content" name="modelContactEn.content">
	<input type="hidden" id="id" name="modelContactEn.id" value='<ww:property value="modelContactEn.id"/>'>   
  <tr>
    ...
    <td>&nbsp;
		<script type="text/javascript">
			...
			oFCKeditor.Value = "<ww:property value="modelContactEn.content"/>";
			oFCKeditor.Create() ;
		</script>
	</td>
  </tr>
