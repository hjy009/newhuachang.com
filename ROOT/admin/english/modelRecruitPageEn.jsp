...
<script language="javascript">
	...
	function queryModelRecruit(id){
		if(openDialog("queryModelRecruitEn.do?id="+id,"查看招工信息",550,300) =="SUCCESS") refresh();
	}
	function prepareAddModelRecruit(){
	<auth:if test="/admin/prepareAddModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareAddModelRecruitEn.do","新增招工信息",850,300) =="SUCCESS") refresh();
	}
	function prepareUpdateModelRecruit(id){
	<auth:if test="/admin/prepareUpdateModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareUpdateModelRecruitEn.do?id="+id,"修改招工信息",850,300) =="SUCCESS") refresh();
	}
	function auditModelRecruit(id,pageId){
	<auth:if test="/admin/auditModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	<auth:if test="/admin/reAuditModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	<auth:if test="/admin/deleteModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	function   SelectAll(){      
	 var  aa = document.getElementsByName("productId");      
	   ...
	   function  shenhe(){
	   <auth:if test="/admin/updateAllModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   ...
	   function  reShenhe(){
	   <auth:if test="/admin/reUpdateAllModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
	...
	function  deleteAll(){
	   <auth:if test="/admin/deleteAllModelRecruitEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
