...
<script>
	...
	<auth:if test="/admin/updateModelEmployessEn.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		...
		form.action = "updateModelEmployessEn.do";
		form.submit();	
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  <input type="hidden" id="content" name="modelEmployessEn.content">
  <input type="hidden" id="id" name="id" value='<ww:property value="modelEmployessEn.id"/>'>   
	<input type="hidden" id="id" name="modelEmployessEn.id" value='<ww:property value="modelEmployessEn.id"/>'>   
  <tr>
    ...
    <td>&nbsp;
		<script type="text/javascript">
			...
			oFCKeditor.Value = "<ww:property value="modelEmployessEn.content"/>";
			oFCKeditor.Create() ;
		</script>
	</td>
  </tr>
