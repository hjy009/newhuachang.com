...
<form id="form" action="" method="POST">
  ...
  <tr>
    <th>学历要求：</th>
    <td>&nbsp;
     <ww:if test="modelAdvertise.degree==\"1\"">
	中专
	</ww:if>
	<ww:elseif test="modelAdvertise.degree==\"2\"">
	高中
	</ww:elseif>
	<ww:elseif test="modelAdvertise.degree==\"3\"">
	大专
	</ww:elseif>
	<ww:elseif test="modelAdvertise.degree==\"4\"">
	本科
	</ww:elseif>
	<ww:elseif test="modelAdvertise.degree==\"5\"">
	硕士
	</ww:elseif>
	<ww:elseif test="modelAdvertise.degree==\"6\"">
	博士
	</ww:elseif>
	<ww:else>
	---
