...
<script>
	function updateModelRecruit(){
		...
		form.action = "updateModelRecruit.do";
		form.submit();	
	...
	function init(){
		...
		doSelect('adPerson',"<ww:property value='modelAdvertise.company'/>");
		highLightInit('row', 'rowover', 'rowselected');
	}
</script>
<body>
<table width="96%" align="center" border="0"><tr><td><div class="title">修改招工信息</div></td></tr></table>
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  ...
  <tr>
   ...
   <th>学历要求：</th>
  	 <td>
  	   <select id="degree" name="modelAdvertise.degree">
  ...
  --%>
    <tr>
    <th><font color="#FF0000"><%--*--%></font>描述：</th>
    <td>&nbsp;
    ...
    <tr>
    <th><font color="#FF0000"><%--*--%></font>要求：</th>
    <td>&nbsp;
		<script type="text/javascript">
			var sBasePath = "/fckeditor/" ;
...
<table width="98%" border="0" cellspacing="0" style="border:0;">
	<tr align="center" style="border:0;">
		<td style="border:0;" align="center">
		  ...
		  <input id="submitButton" type="button" value="修 改"  onclick="updateModelRecruit()">
		</td>
	</tr>
</table>
