...
<script>
	function addModelRecruit(){
		...
		form.action = "addModelRecruit.do";
		form.submit();	
...
<body>
<table width="96%" align="center" border="0"><tr><td><div class="title">新增招工信息</div></td></tr></table>
...
<table width="98%" border="0" cellspacing="0" style="border:0;">
	<tr align="center" style="border:0;">
		<td style="border:0;" align="center">
		  ...
		  <input id="submitButton" type="button" value="新 增"  onclick="addModelRecruit()">
		</td>
	</tr>
</table>
