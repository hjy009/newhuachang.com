...
<title>新增<ww:property value='typeName' /></title>
...
<script>
	...
	<auth:if test="/admin/updateModelEnterprises.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		...
		form.action = "addModelEnterprises.do";
		form.submit();	
...
<ww:hidden name="'id'"></ww:hidden>
 <tr>
  ...
  <tr>
     ...
     <td>
     	<textarea rows="7" cols="80" id="remarks" name="modelEnterprises.remarks" ></textarea>
     </td>
  </tr>
	<tr>
...
<table width="98%" border="0" cellspacing="0" style="border:0;">
	<tr align="center" style="border:0;">
		<td style="border:0;" align="center">
		  ...
		  <input id="submitButton" type="button" value="新 增"  onclick="addModelEnterprises()">
		</td>
	</tr>
</table>
