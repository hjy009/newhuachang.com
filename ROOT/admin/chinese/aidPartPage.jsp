...
<script language="javascript">
	...
	<auth:if test="/admin/prepareUpdateAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareUpdateAidPart.do?id="+id,"修改辅助栏目",850,300) =="SUCCESS") refresh();
	}
	
	function prepareAddAidPart(){
	<auth:if test="/admin/prepareAddAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareAddAidPart.do","新增辅助栏目",850,300)=="SUCCESS") refresh();
	}
	
	function deleteAidPart(id,pageId){
	<auth:if test="/admin/deleteAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	<auth:if test="/admin/auditAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	<auth:if test="/admin/reAuditAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	function   SelectAll(){      
	 var  aa = document.getElementsByName("productId");      
	   ...
	   function  shenhe(){
	   <auth:if test="/admin/updateAllAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   ...
	   function  reshenhe(){
	   <auth:if test="/admin/updateReAllAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
	   ...
	   function  deleteAll(){
	    <auth:if test="/admin/deleteAllAidPart.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
	   ...
	   function queryWeb(path,id){
	   	if(openDialog("/chinese/secondary/aidPartWebPage.do?id="+id,"预览前台",1250,700)==sucess)refresh();
	   }
</script>
</head>
<body>
