...
<script language="javascript">
	...
	<auth:if test="/admin/prepareUpdateModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareUpdateModelVideo.do?id="+id,"修改视频信息",550,300) =="SUCCESS") refresh();
	}
	
	function prepareAddModelVideo(categoryId){
	<auth:if test="/admin/prepareAddModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		if(openDialog("prepareAddModelVideo.do?categoryId="+categoryId,"新增视频信息",550,300)=="SUCCESS")refresh();
	}
	function deleteModelVideo(id,pageId){
	<auth:if test="/admin/deleteModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	<auth:if test="/admin/auditModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	<auth:if test="/admin/reAuditModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	...
	function   SelectAll(){      
	 var  aa = document.getElementsByName("productId");      
	   ...
	   function  shenhe(){
	   <auth:if test="/admin/updateAllModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   ...
	   function  reShenhe(){
	   <auth:if test="/admin/reUpdateAllModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
	   ...
	   function  deleteAll(){
	   <auth:if test="/admin/deleteAllModelVideo.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
	   	var objs=document.getElementsByName("productId");
	   	var ary ="";
		    for(i=0;i<objs.length;i++) {
		        if(objs[i].checked) {
