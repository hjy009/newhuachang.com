...
<body>
<table width="96%" align="center" border="0"><tr><td><div class="title">修改招聘信息</div></td></tr></table>
...
<table width="98%" border="0" cellspacing="0" style="border:0;">
	<tr align="center" style="border:0;">
		<td style="border:0;" align="center">
		  ...
		  <input id="submitButton" type="button" value="修 改"  onclick="updateModelAdvertise()">
		</td>
	</tr>
</table>
