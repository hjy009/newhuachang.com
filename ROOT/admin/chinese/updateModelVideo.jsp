...
<script>
	function updateModelVideo(){
		...
		form.action = "updateModelVideo.do";
		form.submit();	
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  ...
  <tr>
    <th>显示图片：</th>
    <td>&nbsp;<input type="file" id="fileSyImage" name="fileSyImage" value="<ww:property value='modelVideo.imagePath'/>" size="30"><br/>图片：<ww:property value='modelVideo.imagePath'/>
	<br><font color="#FF0000">(上传的图片只支持jpg,gif,bmp格式,大小不能超过500k)</font></td>
  </tr>
  <tr>
    <th>视频：</th>
    <td>&nbsp;<input type="file" id="fileImage" name="fileImage" value="<ww:property value='modelVideo.path'/>" size="30"><br/>视频：<ww:property value='modelVideo.path'/>
