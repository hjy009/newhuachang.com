...
<script>
	function addModelRemeberTheBig(){
		...
		form.action = "addModelRemeberTheBig.do";
		form.submit();	
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  ...
  <input type="hidden" name="modelRemeberTheBig.type" value="<ww:property value='columnsType' />" />
  <tr>
     <th><font color="#FF0000">*</font>年数：</th>
    <td><input type="text"  name="modelRemeberTheBig.year" maxlength="100" id="year"  style="margin-left: 10px;width: 150px" />年</font></td>
  </tr><%--
