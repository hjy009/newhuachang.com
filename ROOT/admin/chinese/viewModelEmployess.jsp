...
<script>
	...
	<auth:if test="/admin/updateModelEmployess.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		...
		form.action = "updateModelEmployess.do";
		form.submit();	
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  <input type="hidden" id="content" name="modelEmployess.content">
  <input type="hidden" id="id" name="id" value='<ww:property value="modelEmployess.id"/>'>   
	<input type="hidden" id="id" name="modelEmployess.id" value='<ww:property value="modelEmployess.id"/>'>   
  <tr>
    ...
    <td>&nbsp;
		<script type="text/javascript">
			...
			oFCKeditor.Value = "<ww:property value="modelEmployess.content"/>";
			oFCKeditor.Create() ;
		</script>
	</td>
  </tr>
