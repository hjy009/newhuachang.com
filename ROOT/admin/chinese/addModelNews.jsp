...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td>&nbsp;<input id="title" name="modelNews.title" value="<ww:property value='modelNews.title'/>" size="50">&nbsp;<font color="#FF0000">(标题不能超过30个文字)</font></td>
  </tr>
  <tr>
...
<tr>
  	...
  	<td>&nbsp;<input id="sequence" name="modelNews.sequence" value="<ww:if test='modelNews.sequence==null'>1</ww:if><ww:elseif test='modelNews.sequence!=null'><ww:property value='modelNews.sequence'/></ww:elseif>" size="30"><font color="#FF0000">*注意:此框只能输入数字，顺序应从1开始，发布日期相同时,数字越大排越后</font></td>
  </tr>
</form>
</table>
