...
<script>
	...
	<auth:if test="/admin/updateModelRemeberTheBig.do" status="false">alert('对不起，您无此权限，请与系统管理员联系!');return;</auth:if>
		...
		form.action = "updateModelRemeberTheBig.do";
		form.submit();	
	...
	function init(){
		doSelect('type',"<ww:property value="modelRemeberTheBig.type"/>");
	}
</script>
<body>
...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  <input type="hidden" id="content" name="modelRemeberTheBig.content">
<ww:hidden name="'id'"></ww:hidden>
 <tr>
     <th><font color="#FF0000">*</font>年数：</th>
    <td><input type="text"  name="modelRemeberTheBig.year" maxlength="100" id="year" value="<ww:property value='modelRemeberTheBig.year'/>"   />年</font></td>
  </tr>
	<%--<tr>
  ...
  --%><tr>
    ...
    <td>&nbsp;
		<script type="text/javascript">
			...
			oFCKeditor.Value = "<ww:property value="modelRemeberTheBig.content"/>";
			oFCKeditor.Create() ;
		</script>
	</td>
  </tr>
