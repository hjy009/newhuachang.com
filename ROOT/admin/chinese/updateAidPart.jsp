...
<form id="form" action="" method="POST" enctype="multipart/form-data">
  ...
  <tr>
  	...
  	<td>&nbsp;<input id="sequence" name="aidpart.sequence" value="<ww:if test='aidpart.sequence==null'>1</ww:if><ww:elseif test='aidpart.sequence!=null'><ww:property value='aidpart.sequence'/></ww:elseif>" size="30"><font color="#FF0000">*注意:此框只能输入数字，顺序应从1开始，发布日期相同时,数字越大排越后</font></td>
  </tr>
</form>
</table>
