...
function sh_ShowHide1()
{
  ...
  if(arguments.length > 2)
  {
    if (arguments[2]==1)
    {
      var currRow = document.getElementById(groupname);
  		currRow.style.display="";
  		document.getElementById(groupname+"img").src = sh_HideImg1;
    }
    else if (arguments[2]==0)
    {
      var currRow = document.getElementById(groupname);
  		currRow.style.display="none";
  		document.getElementById(groupname+"img").src = sh_ShowImg1;
    }
  }
  else
  {
...
function sh_RowShowHide1(sh_RowID) {
	...
	if (currRow.style.display=="none") {
		currRow.style.display="";
		document.getElementById(sh_RowID+"img").src = sh_HideImg1;
	} else {
		currRow.style.display="none";
		document.getElementById(sh_RowID+"img").src = sh_ShowImg1;
	}	
}
