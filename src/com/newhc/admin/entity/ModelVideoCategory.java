...
public class ModelVideoCategory implements java.io.Serializable {
	...
	/** default constructor */
	public ModelVideoCategory() {
	}

	/** minimal constructor */
	public ModelVideoCategory(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public ModelVideoCategory(Integer id, String name, Integer type,
