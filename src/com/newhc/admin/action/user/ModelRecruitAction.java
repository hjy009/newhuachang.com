...
public class ModelRecruitAction extends JSONPrintAction{
	private static final Log logger = LogFactory.getLog(ModelRecruitAction.class);
...
//	private String endTime;
	...
	public String processModelRecruitPageAction(){
...
//		super.setRequestAttribute("typeList",typeList);
	...
	public String processAuditModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
	 ...
	 * @return
	 * */
	public String processReAuditModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
	 ...
	 * @return
	 */
	public String 	processUpdateAllModelRecruitAction(){
	 ...
	 * @return
	 */
	public String 	processReUpdateAllModelRecruitAction(){
		String shenheId=ShenHeId.substring(0,ShenHeId.length()-1);
	    String[] shenhe=shenheId.split(",");
	    ModelAdvertise hs=null;
		try {
	 ...
	 * @return
	 */
	public String 	processDeleteAllModelRecruitAction(){
		String shenheId=ShenHeId.substring(0,ShenHeId.length()-1);
	    String[] shenhe=shenheId.split(",");
	    ModelAdvertise hs=null;
		try {
	 ...
	 * @return
	 */
	public String processQueryModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processPrepareAddModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processAddModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
		List degreeTypeList = DictionaryCache.getValuesListByParentCode(Dictionary.MODEL_ADVERTISE_DEGREE_TYPE);
...
//		modelAdvertise.setEndTime(DateHelper.toDate(endTime,DATE_FORMAT_DAY));
		...
		modelAdvertise.setType(new Integer(2));
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processPrepareUpdateModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
		List degreeTypeList = DictionaryCache.getValuesListByParentCode(Dictionary.MODEL_ADVERTISE_DEGREE_TYPE);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processUpdateModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
		List degreeTypeList = DictionaryCache.getValuesListByParentCode(Dictionary.MODEL_ADVERTISE_DEGREE_TYPE);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processDeleteModelRecruitAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
		try {
			modelAdvertise = DaoFactory.getModelAdvertiseDao().queryModelAdvertiseById(id);
