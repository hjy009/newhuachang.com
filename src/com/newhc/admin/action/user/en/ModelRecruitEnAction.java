...
public class ModelRecruitEnAction extends JSONPrintAction{
	private static final Log logger = LogFactory.getLog(ModelRecruitEnAction.class);
	...
	private String name;
	private Integer type = new Integer(2);// 1:招聘信息 2:招工信息
...
//	private String endTime;
	...
	public String processModelRecruitPageEnAction(){
...
//		super.setRequestAttribute("typeList",typeList);
	...
	public String processAuditModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
	 ...
	 * @return
	 * */
	public String processReAuditModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
	 ...
	 * @return
	 */
	public String 	processUpdateAllModelRecruitEnAction(){
	 ...
	 * @return
	 */
	public String 	processReUpdateAllModelRecruitEnAction(){
		String shenheId=ShenHeId.substring(0,ShenHeId.length()-1);
	    String[] shenhe=shenheId.split(",");
	    ModelAdvertiseEn hs=null;
		try {
	 ...
	 * @return
	 */
	public String 	processDeleteAllModelRecruitEnAction(){
		String shenheId=ShenHeId.substring(0,ShenHeId.length()-1);
	    String[] shenhe=shenheId.split(",");
	    ModelAdvertiseEn hs=null;
		try {
	 ...
	 * @return
	 */
	public String processQueryModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.MODEL_ADVERTISE_DEGREE_TYPE);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processPrepareAddModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processAddModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
		List degreeTypeList = DictionaryCache.getValuesListByParentCode(Dictionary.MODEL_ADVERTISE_DEGREE_TYPE);
...
//		modelAdvertise.setEndTime(DateHelper.toDate(endTime,DATE_FORMAT_DAY));
		...
		modelAdvertiseEn.setType(new Integer(2));
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processPrepareUpdateModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
		List degreeTypeList = DictionaryCache.getValuesListByParentCode(Dictionary.MODEL_ADVERTISE_DEGREE_TYPE);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processUpdateModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
//		List typeList = DictionaryCache.getValuesListByParentCode(Dictionary.ADVERTISE_INFO_TYPE);
		List degreeTypeList = DictionaryCache.getValuesListByParentCode(Dictionary.MODEL_ADVERTISE_DEGREE_TYPE);
...
//		super.setRequestAttribute("typeList",typeList);
	 ...
	 * @return
	 */
	public String processDeleteModelRecruitEnAction(){
		Integer userId = super.getOnlineUserId();
		if(userId==null) throw new ServiceException(ErrorCode.INVALID_REQUEST);
		try {
			modelAdvertiseEn = DaoFactory.getModelAdvertiseEnDao().queryModelAdvertiseEnById(id);
